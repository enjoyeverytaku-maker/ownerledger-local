...
import type { AllocationCandidate, AllocationRecord, ContractRecord, DashboardSummary, DepositTransactionRecord, DocumentRecord, ExpenseRecord, MonthlyChargeRecord, PaymentCsvRow, PaymentRecord, PropertyRecord, RepairRecord, ReportSummary, SetupPayload, SpotChargeRecord, TenantRecord, UnitRecord } from "./types";
